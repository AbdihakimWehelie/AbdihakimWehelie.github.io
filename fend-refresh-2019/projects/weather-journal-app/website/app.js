...
function response(e){
	...
	if(zipInput){
          ...
          console.log(temp);
          postData('https://localhost:8000/add', {date: newDate, temperature: temp, userResponse: feedback});
        })
      ...
      .then(function(){
          ...
          const temp = data.main.temp;
          //console.log(temp);
          postData('https://localhost:8000/add', {temperature: temp, date: newDate, userResponse: feedback});
        })
